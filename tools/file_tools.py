...
READ_FILE_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "limit": {"type": "integer", "description": "Maximum number of lines to read (default: 200, max: 2000). Reads are additionally capped at a ~100K-character budget with a next_offset continuation.", "default": 200, "maximum": 2000}
        },
        "required": ["path"]
    }
}
