...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "Create only when the user explicitly asks for that specific new skill. "
        "Never infer creation from task complexity, errors, corrections, or a reusable workflow.\n"
        "Update when: instructions stale/wrong, OS-specific failures, "
        "missing steps or pitfalls found during use. "
        "Propose the smallest update and apply it only after explicit user approval.\n\n"
        "Do not proactively offer to create a skill after difficult or iterative tasks. "
